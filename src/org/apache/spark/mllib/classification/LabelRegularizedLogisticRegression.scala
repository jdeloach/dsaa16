 ...
 */
@Since("0.8.0")
class LRLogisticRegressionWithSGD private[mllib] (
  ...
  @Since("0.8.0")
  override val optimizer = new LabelRegularizedGradientDescent(gradient, updater)
 ...
 */
@Since("0.8.0")
object LRLogisticRegressionWithSGD {
  ...
  def train(
    ...
    new LRLogisticRegressionWithSGD(stepSize, numIterations, 0.0, miniBatchFraction)
